...
<a href="plink:{'0':'default!','1':10,'a':20,'b':30}"></a>

<a href="plink:['default!#hash',10,20]"></a>
EOD
...
<a n:phref="Homepage:"></a>

<a n:phref="default! 10, 'a' => 20, 'b' => 30"></a>

<a n:phref="default!#hash 10, 20"></a>
EOD
, $params), ['&#039;' => "'"]));
